        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <?php  foreach ($result['result'] as $ru){?>
              <tr>
                <td>
                    <p>微信名称: <?php echo $ru['name'] == '0' ? '<span style="color:red">Unused</span>' : '<span style="color:red">'.$ru['name'].'</span>';?>  [ 今日总额: <span style="color: green;"><?php echo $ru['today_money'];?></span> / 笔数: <span style="color: red;"><?php echo $ru['today_pens'];?></span> ] ( <a href="<?php echo url::s('admin/wechat/automaticOrder',"sorting=wechat&code={$ru['id']}");?>">交易订单</a> )</p>
