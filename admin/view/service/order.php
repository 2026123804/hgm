        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <?php  foreach ($result['result'] as $ru){ ?>
              <tr>
                <td>设备ID：<a href='<?php echo url::s("admin/service/index","sorting=service&code={$ru['service_id']}");?>'><?php echo $ru['service_id'];?></a> / 类型：<?php if ($ru['types'] == 1) echo '<span style="color:green;">微信</span>';if ($ru['types'] == 2) echo '<span style="color:red;">支付宝</span>';?> ( <a target="_blank" href="<?php echo url::s('gateway/pay/service',"id={$ru['id']}");?>">支付链接</a> )
