...
class alipayAutomatic{
    ...
    public function uploadOrder(){
        ...
        $find_order = $this->mysql->query('client_alipay_automatic_orders',"alipay_id={$id} and status=2 and amount={$money} and trade_no={$order}")[0];
        ...
        functions::json(200, ' ['.date("Y/m/d H:i:s",time()).']: 支付宝ID->' . $id . ' 订单处理完成');
    }
