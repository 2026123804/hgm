      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <a onclick="add();" style="font-size: 14px;" class="btn waves-effect waves-light  cyan darken-2"><i class="mdi-content-add left" style="width: 10px;"></i>添加支付宝</a>
            <a onclick="setting();" style="font-size: 14px;" class="btn waves-effect waves-light  cyan darken-2"><i class="mdi-action-settings left" style="width: 10px;"></i>支付宝配置</a>
                  ...
                  <table class="striped"  style="font-size: 14px;">
                    ...
                    <?php foreach ($result['result'] as $ru){?>
                      <tr>
                        ...
                        <td>
                        Name: <?php echo $ru['name'] == '0' ? '<span style="color:red;">Unused</span>' : '<span style="color:green;">'.$ru['name'].'</span>';?> [ 今日总额: <span style="color: green;"><?php echo $ru['today_money'];?></span> / 笔数: <span style="color: red;"><?php echo $ru['today_pens'];?></span> ] ( <a href="#" onclick="del('<?php echo $ru['id'];?>');" style="color:#757575;">删除支付宝</a> )
                        ...
                        <td><?php if ($ru['status']!=6 && $ru['status']!=4){?><a onclick="login('<?php echo $ru['id'];?>');" style="font-size: 14px;" class="btn waves-effect waves-light indigo"><i class="mdi-action-lock-open left" style="width: 10px;"></i>登录</a><?php }else {echo '<span style="color:#4caf50;;">alipay online</span>';}?></td>
                      </tr>
                    <?php }?>
                    </tbody>
                  </table>
