                ...
                <div class="col s12 m8 l9">
                  <div class="input-field col s12">
                    ...
                    <select onchange="update(this);">
                      ...
                      <option value="1" <?php if (userCog::read('automaticConfig', $_SESSION['MEMBER']['uid'])['robin'] == 1) echo 'selected';?>>随机微信 [v1.2] - 推荐</option>
                      <option value="2" <?php if (userCog::read('automaticConfig', $_SESSION['MEMBER']['uid'])['robin'] == 2) echo 'selected';?>>实时收款 [v1.0] - 按照少到多排序</option>
                      <option value="3" <?php if (userCog::read('automaticConfig', $_SESSION['MEMBER']['uid'])['robin'] == 6) echo 'selected';?>>顺序模式 [v1.0] - 自动顺序选择 - 不推荐</option>
                    </select>
                  </div>
                </div>
